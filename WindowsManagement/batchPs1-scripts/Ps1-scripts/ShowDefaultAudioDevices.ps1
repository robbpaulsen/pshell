...
SYNOPSIS
Use powershell to enumerate the default audion devices on target machine.

USAGE
1. Run script with a visible console
...
write-host "Default Microphone  : $(getFriendlyName $id1)"
