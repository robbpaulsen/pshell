...
Write-Host "`nInstalling winget - " -ForegroundColor Yellow -NoNewline; Write-Host "[1-11]" -ForegroundColor Green -BackgroundColor Black
...
Write-Host "`nInstalling winget - " -ForegroundColor Yellow -NoNewline; Write-Host "[2-11]" -ForegroundColor Green -BackgroundColor Black
...
# Install PS7 
Write-Host "`nInstalling Powershell 7 - " -ForegroundColor Yellow -NoNewline; Write-Host "[3-11]" -ForegroundColor Green -BackgroundColor Black
...
Write-Host "`nInstalling Windows Terminal - " -ForegroundColor Yellow -NoNewline ; Write-Host "[4-11]" -ForegroundColor Green -BackgroundColor Black
...
Write-Host "`nInstalling glyphed fonts for OMP [Caskaydia Cove Nerd] - " -ForegroundColor Yellow -NoNewline ; Write-Host "[5-11]" -ForegroundColor Green -BackgroundColor Black
try {
...
Write-Host "`nApplying WT.exe settings.json with env variables - " -ForegroundColor Yellow -NoNewline ; Write-Host "[6-11]" -ForegroundColor Green -BackgroundColor Black
...
Write-Host "`nSetting PSGallery as trusted repo - " -ForegroundColor Yellow -NoNewline ; Write-Host "[7-11]" -ForegroundColor Green -BackgroundColor Black
Install-PackageProvider -Name NuGet -Force | Out-Null
Set-PSRepository -Name 'PSGallery' -InstallationPolicy Trusted

# Oh-My-Posh install, add to default prompt, add theme
Write-Host "`nInstalling Oh-MyPosh & theme - "  -ForegroundColor Yellow -NoNewline ; Write-Host "[8-11]" -ForegroundColor Green -BackgroundColor Black
...
# Set PS profile
Write-Host "`nApplying Powershell profile - " -ForegroundColor Yellow -NoNewline ; Write-Host "[9-11]" -ForegroundColor Green -BackgroundColor Black
try {
    if (Test-Path $profile.CurrentuserAllHosts) { Rename-Item $profile.CurrentuserAllHosts -NewName Microsoft.PowerShell_profile.ps1.bak }
}
catch { Write-Warning $_ }
try {
...
Write-Host "`nInstalling Z,PsReadLine,Terminal-Icons modules - "  -ForegroundColor Yellow -NoNewline ; Write-Host "[10-11]" -ForegroundColor Green -BackgroundColor Black
...
Write-Host "`nApplying Windows Terminal default settings - " -ForegroundColor Yellow -NoNewline ; Write-Host "[11-11]" -ForegroundColor Green -BackgroundColor Black
try {
