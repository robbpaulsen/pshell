...
:: Schedule to open at every logon -- this requires Administrator access                               iexplore.exe' 'http://www.hasbro.com/mylittlepony/en_US/'"%SystemDrive%\Program Files\Internet Explorer\i
