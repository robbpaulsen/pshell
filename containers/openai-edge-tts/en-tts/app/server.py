...
DEFAULT_VOICE = os.getenv('DEFAULT_VOICE', 'en-GB-SoniaNeural')
DEFAULT_RESPONSE_FORMAT = os.getenv('DEFAULT_RESPONSE_FORMAT', 'mp3')
DEFAULT_SPEED = float(os.getenv('DEFAULT_SPEED', 1.3))
...
# http://localhost:5050/elevenlabs/v1/text-to-speech/en-GB-SoniaNeural
