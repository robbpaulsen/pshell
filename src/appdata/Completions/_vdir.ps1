...
Register-ArgumentCompleter -Native -CommandName 'vdir' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'vdir' {
            ...
            [CompletionResult]::new('--time', '--time', [CompletionResultType]::ParameterName, 'Show time in <field>: 	access time (-u): atime, access, use; 	change time (-t): ctime, status. 	modification time: mtime, modification. 	birth time: birth, creation;')
